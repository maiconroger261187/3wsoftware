                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-3 d-none d-lg-block">
                        ...
                        <div class="quick-contact-icons d-flex">
                            ...
                            <div class="text">
                                <span class="h4 d-block">Joinville</span>
                                <span class="caption-text">SC/Brasil</span>
                            </div>
                        </div>
                        ...
                        <div class="mr-auto">
                            <nav class="site-navigation position-relative text-right" role="navigation">
                                <ul class="site-menu main-menu js-clone-nav mr-auto d-none pl-0 d-lg-block">
                                    <li class="nav-link">
                                        <a class=" text-left" title="Home" href="<?= url(); ?>">Home</a>
                                    </li>
                                    <li>
                                        <a class="nav-link text-left" title="Sobre" href="<?= url(); ?>">Sobre</a>
                                    </li>
                                    <li>
...
<section class="main_optin">
        <article class="main_optin_content">
                ...
                <header class="""main_optin_content header">
...
<script src="shared/js/stickyfill.min.js"></script>
